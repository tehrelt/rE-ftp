...
export const InputBox = ({ label, id, placeholder, type, callback, value, max, min }: Props) => {
    ...
    return (
        <div className="flex gap-x-1 items-center">
            ...
            <input
                ...
                max={max}
                min={min}
                className="block w-full rounded-md border-0 py-1.5 pl-3 pr-12 text-gray-900
